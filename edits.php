...
$form =<<<EOT
<div id="top_common">
<div id="arrow"><table><tr><td><a href="project_manager.php"><img src="img/h2.png"></a></td><td align="right"><button><a href="index.php">LOGOUT</a></button></td></tr></table></div>
</div>
<ol class="breadcrumb">
    <li><a href="project_manager.php">Home</a></li>
    <li><a href="user_views.php">User View</a></li>
...
echo $form;
?>
  <form name="Update employee" role="form" align = "left" method="post" action="edits.php">
