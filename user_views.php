...
function showU(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","m_uview.php?r="+str,true);
        xmlhttp.send();
    }
}
</script>
...
<body>
  <div>
<div id="top_common">
<div id="arrow"><table><tr><td><a href="project_manager.php"><img src="img/h2.png"></a></td><td id="Header_topic">Users Details</td><td align="right"><button><a href="index.php">LOGOUT</a></button></td></tr></table></div>
</div>
<ol class="breadcrumb">
