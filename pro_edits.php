...
$sql="UPDATE users 
SET  id='$id', fname='$fname', lname='$lname',uname='$uname',email='$email', dateOFbirth='$dateOFbirth',address='$address', contact= '$contact', password='$password' WHERE 
id='$id'";
...
echo $form;
?>
  <form name="Update employee" role="form" align = "left" method="post" action="">
                   ...
                   <input type="tel" class="form-control" name = "contact" value="<?php echo $query2['contact']; ?>" onblur="phonenumber(this);"/>
                          ...
                          <br><br>
                           <div class="form-group" align = "left">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control"  name = "Password" value="" onblur="checkValidPassword(this);"/>
                            </div><div class="col-md-3" id="password"></div>
                          </div>
                          <br><br>
                           <div class="form-group" align = "left">
                            <label for="inputDate" class="col-md-3 control-label">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control"  name = "cpassword" value="" onblur="checkValidCPassword(this);"/>
                            </div><div class="col-md-3" id="cpassword"></div>
                          </div>
