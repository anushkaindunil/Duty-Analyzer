...
if ($id_task<10) {
	...
	?>
<div id="top_common">
<div id="arrow"><table><tr><td><a href="main_manager.php"><img src="img/h2.png"></a></td><td id="Header_topic">Add task to :  <?php echo  $proid;?></td><td align="right"><button><a href="logout.php">LOGOUT</a></button></td></tr></table></div>
</div>
<div>
	<ol class="breadcrumb">
...
<table><tr><td width="320px" align="center">Task ID</td><td width="320px" align="center">Task Name</td><td width="320px" align="center">Define Time(Days)</td></tr></table>
</div>
<div id="small">
<?php
$query1=mysql_query("SELECT * FROM tasks WHERE pro_id='$proid'");
...
{
	$tsk= $query2['task_id'];
	$tsktime=$query2['task_time']/8;
	?>

<table><form action="" method="POST"><tr><td><button title="add usres to task" name="submit" id="taskin" value="<?php echo $tsk;?>" ><table><tr><td width="400px" align="center"><?php echo $query2['task_id'];?></td><td width="400px" align="center"><?php echo $query2['task_name'];?></td><td width="400px" align="center"><?php echo $tsktime;?></td></tr></table></button></td><td><button id="edit" name="tskEdit" value='<?php echo $query2['task_id'];?>' >EDIT</button></td><td><button id="delete" name="tskDelete" value='<?php echo $query2['task_id'];?>' onclick="return confirm('Are you sure?')" >DELETE</button></td></tr></form></table>
<hr>
<?php
}
}
...
if(isset($_POST['ADD'])){
	...
	?>
    <script type="text/javascript">
		window.location.href="taskAddToProject.php";
	</script>
	<?php
}
...
if (isset($_POST['submit'])) {
	...
	?>
    <script type="text/javascript">
		window.location.href="U_adds_after.php";
	</script>
	<?php
}
