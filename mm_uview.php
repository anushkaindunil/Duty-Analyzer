...
function getProgressBar($smallTime, $LargeTime){//get percentage for getting progress bar
...
function remainingTime($smallTime ,$LargeTime){//getting remaing time
...
<?php
echo "<tr><td><a href='edit.php?id=".$id."'><button class='AnuButton'>Edit</button></a></td>";
echo "<td><a href='Delete.php?id=".$id."' onclick=\"return confirm('Are you sure?')\"><button class='AnuButton'>Delete</button> </a></td></tr>";
