...
<ol class="breadcrumb">
    <li><a href="main_manager.php">Home</a></li>
     ...
     <li><a href="taskAddToProject.php">Add Task</a></li>
...
while($query2 = mysql_fetch_array($query1))
{
    ...
    ?>
<form action=""method="POST">
<table><tr><td><?php echo $tsk;?></td><td><?php echo $emp;?></td><td><?php echo $position;?></td><td></td><td><button id="delete" name="deleteAllocateEmployees" value='<?php echo $emp;?>' onclick="return confirm('Are you sure?')" >DELETE</button></td></tr></table></form>
<hr>
<?php
}
...
if(isset($_POST['subm'])){
   $pro= substr($tid, 0, 5);
    ...
    $allocate_time=$rows6['task_time']/$num_rows;
    //echo $allocate_time;
...
window.location.href="finishpro_after.php";
